...
_CRTIMP2 const _Dconst _FEps = {
	INIT((_FBIAS - NBITS - 1) << _FOFF)};
_CRTIMP2 const _Dconst _FInf = {INIT(_FMAX << _FOFF)};
_CRTIMP2 const _Dconst _FNan = {INIT((_FMAX << _FOFF)
	| (1 << (_FOFF - 1)))};
_CRTIMP2 const _Dconst _FSnan = {INIT2(_FMAX << _FOFF, 1)};
_CRTIMP2 const _Dconst _FRteps = {
