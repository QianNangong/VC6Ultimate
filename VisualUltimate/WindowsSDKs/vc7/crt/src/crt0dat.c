 ...
 */
/*
 * _fpmath now allows the caller to suppress floating point precision init
        ...
        )
{
        ...
        /*
        When a DLL loads the CRT, it suppresses floating point initialisation, since
        by that point the process should have already establised floating point policy
        */
        /*
