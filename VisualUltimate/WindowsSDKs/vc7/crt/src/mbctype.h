...
#ifndef _INTERNAL_IFSTRIP_
#ifdef _MT
#define __ismbbalnum_mt(p, _c)  (((_pctype)[(unsigned char)(_c)] & \
                                (_ALPHA|_DIGIT)) || \
                                ((p->mbctype+1)[(unsigned char)(_c)] & _MS))
#define __ismbbalpha_mt(p, _c)  (((_pctype)[(unsigned char)(_c)] & \
                                (_ALPHA)) || \
                                ((p->mbctype+1)[(unsigned char)(_c)] & _MS))
#define __ismbbgraph_mt(p, _c)  (((_pctype)[(unsigned char)(_c)] & \
                                (_PUNCT|_ALPHA|_DIGIT)) || \
                                ((p->mbctype+1)[(unsigned char)(_c)] & (_MS|_MP)))
#define __ismbbprint_mt(p, _c)  (((_pctype)[(unsigned char)(_c)] & \
                                (_BLANK|_PUNCT|_ALPHA|_DIGIT)) || \
                                ((p->mbctype + 1)[(unsigned char)(_c)] & (_MS|_MP)))
#define __ismbbpunct_mt(p, _c)  (((_pctype)[(unsigned char)(_c)] & _PUNCT) || \
