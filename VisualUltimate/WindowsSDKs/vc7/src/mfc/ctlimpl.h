...
#ifdef _AFX_DLL_IMPL
	__declspec(noinline) virtual ~_AFXCTL_AMBIENT_CACHE() { }
#endif
...
#ifdef _AFX_DLL_IMPL
	__declspec(noinline) virtual ~CControlFrameWnd() { }
#endif
...
#ifdef _AFX_DLL_IMPL
	_declspec(noinline) virtual ~CReflectorWnd() { }
#endif
...
#ifdef _AFX_DLL_IMPL
	__declspec(noinline) virtual ~CParkingWnd() { }
#endif
