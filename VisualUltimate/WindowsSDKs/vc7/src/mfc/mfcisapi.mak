...
!if "$(PLATFORM)" == "IA64" || "$(PLATFORM)" == "ALPHA64" || "$(PLATFORM)" == "AMD64"
WIN64=1
!endif
...
!if "$(PLATFORM)" == "AMD64"
!if "$(DEBUG)" != "0"
INETASM=x8664\inetcald.obj
!else
INETASM=x8664\inetcaln.obj
!endif
!endif
...
$(INETASM) : x8664\inetcal_.s
	ml64 $(ASMOPT) -c -Fo$@ x8664\inetcal_.s
