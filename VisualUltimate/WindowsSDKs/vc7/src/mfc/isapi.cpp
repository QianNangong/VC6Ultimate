...
_AfxParseCall(AFX_PISAPICMD pfn, void* pArgs, UINT nSizeArgs, UINT, UINT, UINT, UINT, UINT );
#else
extern "C" DWORD AFXISAPI
	...
	AFX_PARSEMAP_ENTRY* pParams, LPTSTR pszParams)
{
	...
	if (nRet == callOK)
	{
		...
		{
#ifdef _IA64_
			DWORD (AFXISAPI *pfnInet)(AFX_PISAPICMD, void*, UINT, UINT, UINT, UINT, UINT, UINT ) =
				&_AfxParseCall;
			pfnInet(pfn, pStack, nSizeArgs, 0, 0, 0, 0, 0 );
#else
