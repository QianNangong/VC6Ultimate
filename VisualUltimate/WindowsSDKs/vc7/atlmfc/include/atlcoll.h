...
template< typename E, class ETraits >
inline E& CAtlList< E, ETraits >::GetHead() throw()
{
...
template< typename E, class ETraits >
inline const E& CAtlList< E, ETraits >::GetHead() const throw()
{
	ATLASSERT( m_pHead != NULL );
	return( m_pHead->m_element );
}
...
template< typename E, class ETraits >
inline E& CAtlList< E, ETraits >::GetTail() throw()
{
...
template< typename E, class ETraits >
inline const E& CAtlList< E, ETraits >::GetTail() const throw()
{
	ATLASSERT( m_pTail != NULL );
	return( m_pTail->m_element );
}
...
template< typename E, class ETraits >
inline E& CAtlList< E, ETraits >::GetAt( POSITION pos ) throw()
{
	CNode* pNode;
...
template< typename E, class ETraits >
inline const E& CAtlList< E, ETraits >::GetAt( POSITION pos ) const throw()
{
	CNode* pNode;
...
template< typename E, class ETraits >
void CAtlList< E, ETraits >::RemoveAt( POSITION pos ) throw()
{
	ATLASSERT_VALID(this);
...
template< typename K, typename V, class KTraits, class VTraits >
inline const K& CAtlMap< K, V, KTraits, VTraits >::GetKeyAt( POSITION pos ) const throw()
{
	CNode* pNode;
...
template< typename K, typename V, class KTraits, class VTraits >
inline const V& CAtlMap< K, V, KTraits, VTraits >::GetValueAt( POSITION pos ) const throw()
{
	CNode* pNode;
...
template< typename K, typename V, class KTraits, class VTraits >
inline V& CAtlMap< K, V, KTraits, VTraits >::GetValueAt( POSITION pos ) throw()
{
	CNode* pNode;
...
template< typename K, typename V, class KTraits, class VTraits >
void CAtlMap< K, V, KTraits, VTraits >::RemoveNode( CNode* pNode, CNode* pPrev ) throw()
{
	UINT iBin;
...
template< typename K, typename V, class KTraits, class VTraits >
void CAtlMap< K, V, KTraits, VTraits >::RemoveAtPos( POSITION pos ) throw()
{
	CNode* pNode;
	CNode* pPrev;
	UINT iBin;
...
template< typename K, typename V, class KTraits, class VTraits >
inline void CRBTree< K, V, KTraits, VTraits >::SetNil(CNode **p) throw()
{
	ATLASSERT( p != NULL );
