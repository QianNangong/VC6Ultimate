                                ...
                                )
                            {
                                if (!suppress) {
                                    ...
                                    if (fl_wchar_arg) {
                                        ...
                                        if (isleadbyte(ch))
                                            temp[1] = (char) INC();
                                        mbtowc(&wctemp, temp, __MB_CUR_MAX(ptloci));
...
f_incwidth:
                        ...
                        if (*__LCONV(ptloci)->decimal_point == (char)ch && width--) {
                            ch = INC();
                            *scanptr++ = *__LCONV(ptloci)->decimal_point;
...
f_incwidthw:
                        ...
                        mbtowc (&wdecimal, __LCONV(ptloci)->decimal_point, __MB_CUR_MAX(ptloci));
