...
_AfxDispatchCall(AFX_PMSG pfn, void* pArgs, UINT nSizeArgs, UINT nTemp1, UINT nTemp2, UINT nTemp3, UINT nTemp4, UINT nTemp5 );
#else
extern "C" DWORD_PTR AFXAPI
	...
	VARIANT* pvarResult, DISPPARAMS* pDispParams, UINT* puArgErr)
{
	...
	if (sc == S_OK)
	{
		TRY
		{
...
#ifdef _IA64_
			DWORD_PTR (AFXAPI *pfnDispatch)(AFX_PMSG, void*, UINT, UINT, UINT, UINT, UINT, UINT ) =
#else
			...
			case VT_R4:
#ifdef _IA64_
				result.fltVal = ((float (AFXAPI*)(AFX_PMSG, void*, UINT, UINT, UINT, UINT, UINT, UINT ))
					pfnDispatch)(pfn, pStack, nSizeArgs, 0, 0, 0, 0, 0 );
#else
			...
			case VT_R8:
#ifdef _IA64_
				result.dblVal = ((double (AFXAPI*)(AFX_PMSG, void*, UINT, UINT, UINT, UINT, UINT, UINT ))
					pfnDispatch)(pfn, pStack, nSizeArgs, 0, 0, 0, 0, 0 );
#else
			...
			case VT_DATE:
#ifdef _IA64_
				result.dblVal = ((DATE (AFXAPI*)(AFX_PMSG, void*, UINT, UINT, UINT, UINT, UINT, UINT ))
					pfnDispatch)(pfn, pStack, nSizeArgs, 0, 0, 0, 0, 0 );
#else
			...
			default:
#ifdef _IA64_
				dwResult = pfnDispatch(pfn, pStack, nSizeArgs, 0, 0, 0, 0, 0 );
#else
