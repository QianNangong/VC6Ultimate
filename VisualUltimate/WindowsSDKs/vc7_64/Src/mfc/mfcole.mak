...
LFLAGS=$(LFLAGS) /version:6.00 /base:0x5F500000
LIBS=$(MFCDLL) $(CRTDLL) kernel32.lib gdi32.lib user32.lib uuid.lib oledb.lib oleaut32.lib
...
$D\$(TARG).res: mfcole.rc ..\include\afxbld_.h
