...
int CWinApp::ExitInstance()
{
	...
	return (int)m_msgCur.wParam; // returns the value from PostQuitMessage
}
...
void CWinApp::Dump(CDumpContext& dc) const
{
	...
	dc << "m_hInstance = " << (UINT_PTR)m_hInstance;
	dc << "\nm_hPrevInstance = " << (UINT_PTR)m_hPrevInstance;
